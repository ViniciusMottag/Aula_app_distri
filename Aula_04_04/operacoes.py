...
def potencia_de_dois_melhor(expoente):
        return jsonify({"resposta":(2**expoente)})
...
Use as query strings, como no exemplo soma_url

Ali
as, lembre no exemplo: as query strings nao precisam ser colocadas
no app.route. Elas aparecem de outra forma, em um dicionário.
'''
@app.route('/ola_upgrade')
def ola2():
    dicionario_ola2 = request.args
    print(dicionario_ola2)
    if 'pessoa1' not in dicionario_ola2:
        nome1 = None
    else:
        nome1 = dicionario_ola2['pessoa1']
    if 'pessoa2' not in dicionario_ola2:
        nome2= None
    else:
        nome2 = dicionario_ola2['pessoa2']
    if nome1 == None or nome2 == None :
        return jsonify({'erro':'faltando uma variável'}), 400
       
    
    return "ola "+nome1+" e "+nome2
...
def ola3():
    dicionario_ola3 = request.json
    print(dicionario_ola3)
    if 'pessoa1' not in dicionario_ola3:
        nome1 = None
    else:
        nome1 = dicionario_ola3['pessoa1']
    if 'pessoa2' not in dicionario_ola3:
        nome2= None
    else:
        nome2 = dicionario_ola3['pessoa2']
    if nome1 == None or nome2 == None :
        return jsonify({'erro':'faltando uma variável'}), 400 
...
def ola4():
    dicionario_ola4 = request.args
    if 'pessoa1' not in dicionario_ola4:
        nome1 = None
    else:
        nome1 = dicionario_ola4['pessoa1']
    if 'pessoa2' not in dicionario_ola4:
        nome2= None
    else:
        nome2 = dicionario_ola4['pessoa2']
    if nome1 == None or nome2 == None :
        return jsonify({'erro':'falta gente'}), 400
    dicionario=({"pessoa1":nome1,"pessoa2":nome2})
    return jsonify(dicionario)
...
@app.route('/')
def rodando():
    return 'o servidor operacoes está rodando!'
